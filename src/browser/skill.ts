...
const TAKING_ACTIONS_INSTRUCTIONS = [
  ...
  '',
  '1. Before any step that submits, buys, books, posts, sends, deletes, signs up, or otherwise changes data, call `browser_act` for that step with mayChangeData set to true. Nothing happens yet: it returns awaitingApproval with an actionId and a description, and attaches a picture of the page.',
  '2. Tell the person exactly what the step will do and ask them to reply "approve" in this thread to let you take it, or "stop". Then end your reply. Never claim the step was taken.',
