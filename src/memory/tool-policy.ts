...
export const EXTERNAL_TARGET_PATTERN =
  'accounts?|ads?|associations?|branches?|budgets?|calendars?|campaigns?|cards?|comments?|compan(?:y|ies)|contacts?|deals?|deployments?|documents?|emails?|events?|files?|folders?|issues?|items?|jobs?|keywords?|meetings?|members?|messages?|notes?|orders?|pages?|payments?|playlists?|presentations?|projects?|prs?|pull requests?|records?|repos?|repositories|rows?|sheets?|slides?|spreadsheets?|tasks?|templates?|thumbnails?|tickets?|trackers?|users?|videos?|workflows?';
