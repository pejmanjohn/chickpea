...
const TOOL_DESCRIPTIONS: Record<WorkspaceManagementToolName, string> = {
  inspect_workspace: 'Inspect current non-secret Chickpea Agents, skills, connections, repositories, Channels, provider availability, and Owner-only team authority. The connectors field is a setup catalog, not current access; currentAgent.effectiveConnections lists executable connected-service access for the routed Agent, and an empty array means none. Required before recommending specific capabilities for Agent design or answering what services an Agent can use.',
