...
export const managementOperationZodSchema = z.discriminatedUnion('kind', [
  ...
  z.strictObject({
    ...
    destination: z.strictObject({ kind: z.enum(['current_dm_thread', 'current_channel_thread']) }).optional(),
...
export const managementOperationValibotSchema = v.variant('kind', [
  ...
  v.strictObject({
    ...
    destination: v.optional(v.strictObject({ kind: v.picklist(['current_dm_thread', 'current_channel_thread']) })),
