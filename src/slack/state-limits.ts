 ...
 * after a crashed worker. They outlive the longest admitted turn: a turn that
 * delegates coding tasks can run for up to its submission budget (see
 * CHICKPEA_SUBMISSION_DURABILITY in src/agents/coding-worker-task.ts). */
export const ACTIVE_WORK_TTL_MS = 160 * 60 * 1000;
