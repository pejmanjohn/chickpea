  ...
  if (deployedUrl) {
    process.stdout.write(
      [
        ...
        '    2. Use CHICKPEA_RECOVERY_TOKEN once to authorize owner setup.',
        '    3. Configure verified-email sign-in once for both /admin and /admin/*.',
        '    4. Verify your Access identity, then continue to Slack setup.',
        '',
        '  Keep the recovery credential offline after setup. It is not an Admin login.',
        '  docs/authentication.md has the advanced Access path; SETUP_AGENT.md covers Slack.',
        RULE,
        '',
      ].join('\n'),
    );
    ...
    process.stdout.write(
      [
        ...
        '',
        '  Then: complete the guided Cloudflare Access setup and continue to Slack.',
        RULE,
        '',
      ].join('\n'),
    );
