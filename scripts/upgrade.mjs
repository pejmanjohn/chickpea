...
function targetEnvironment(target, { deploy = false } = {}) {
  ...
  Object.assign(env, { CLOUDFLARE_ACCOUNT_ID: target.account, WRANGLER_CI_OVERRIDE_NAME: target.worker, CHICKPEA_DEPLOY_PROFILE: target.profile });
